...
$(error Wrong directorry for the project. It must be in $GOPATH/github/Percona-Lab/minimum_permissions)
endif
...
linux-386: prepare
	...
	@GOOS=linux GOARCH=386 go build -ldflags ${LDFLAGS} -o ${BIN_DIR}/minimum_permissions main.go

linux-386-tar: linux-386
	@tar cvzf ${BIN_DIR}/minimum_permissions_linux_386.tar.gz -C ${BIN_DIR} minimum_permissions
